// PROTOTYPE — Tarea 11, Variante A: fan radial. Throwaway, ver NOTES.md.
import { useState } from "react"
import { Link, useLocation } from "react-router-dom"
import { FAB_PROTO_ITEMS } from "./items"
import "./FootballFabPrototype.css"

export default function FootballFabPrototypeA() {
  const [open, setOpen] = useState(false)
  const location = useLocation()

  return (
    <div className={`fab-proto fab-proto-fan${open ? " fab-proto-open" : ""}`}>
